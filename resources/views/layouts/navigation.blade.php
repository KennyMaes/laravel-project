<nav x-data="{ open: false }" class="w-full bg-white border-b border-gray-100 rounded-b-lg mb-4">
        ...
        <div class="h-16">
            <div class="flex justify-start gap-4">
                ...
                <div class="flex grow justify-between">
                    <div class="hidden sm:-my-px sm:flex gap-4">
                ...
                @else
                    <div class="flex grow justify-between pt-2">
